...
import { HIGHLIGHTS } from '@/data/portfolio-static';
    ...
    >
      <Reveal>
        <SectionHeading
          number="02"
          title="Side Quests"
          subtitle="Personal builds and experiments beyond the day job."
        />
      </Reveal>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {HIGHLIGHTS.sideQuests.map((quest, i) => {
          const isExternal = quest.link.startsWith('http');
          const inner = (
            <>
