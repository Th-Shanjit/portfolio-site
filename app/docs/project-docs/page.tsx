  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-32 animate-in fade-in duration-1000 min-h-[80vh]">
      <div className="mb-16 max-w-2xl">
        <h1 className="text-5xl font-light tracking-tight text-zinc-900 mb-4">Project docs</h1>
        <p className="text-lg font-light text-zinc-500">App documentations and project assets.</p>
      </div>
      {docs.length === 0 ? (
        <p className="text-zinc-500 font-light">No project docs yet.</p>
      ) : (
