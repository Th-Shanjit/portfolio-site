...
export default function ProjectDocsPage() {
  ...
  // Using (doc: any) prevents the TypeScript overlapping error
  const projectDocs = data.docs.filter((doc: any) => doc.type === 'Project Docs');
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-40 min-h-[80vh] font-light">
      <div className="mb-24">
        ...
        <h1 className="text-5xl tracking-tight text-zinc-900">Project Docs</h1>
      </div>
